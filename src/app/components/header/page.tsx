...
const Header = () => {
  return (
    <header className="flex justify-between items-center px-4 lg:px-20 py-4 bg-white shadow-md" style={{ height: "124px" }}>
     ...
     <span className="border rounded-full p-2"><GoHeartFill size={20} /></span> 
     <span className="relative border rounded-full p-2">

     <span className="border rounded-full w-3 h-3 absolute -top-1 left-5  bg-red-500  "></span> <TbBellFilled size={20} />
     </span>


     <span className="border rounded-full p-2"> <IoMdSettings size={20} /></span>
